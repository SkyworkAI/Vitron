...
HF_DATASETS_OFFLINE=1 TRANSFORMERS_OFFLINE=1 deepspeed --include localhost:5,6 --master_addr 127.0.0.1 --master_port 28459 train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/vitron-7b-lora-7 \
    --num_train_epochs 2 \
