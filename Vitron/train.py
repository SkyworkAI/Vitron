...
from videollava.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, \
    ...
    MAX_VIDEO_LENGTH
from videollava.constants import OBJS_TOKEN_INDEX, DEFAULT_OBJS_TOKEN, DEFAULT_OBJS_PATCH_TOKEN,DEFAULT_OBJS_START_TOKEN, \
...
from videollava.mm_utils import tokenizer_image_token, tokenizer_image_region_token, show_image_with_bboxes, preprocess_region
...
class DataCollatorForSupervisedDataset(object):
    ...
    def __call__(self, instances: Sequence[Dict]) -> Dict[str, torch.Tensor]:
        ...
        #     if 'region' not in instance.keys():
        #         print('not all instances has the region key-------')
        #         print(instance)
        #         exit(0)
        # print('ddddddddd')
