...
from vitron.constants import IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN, \
    DEFAULT_VIDEO_TOKEN
from vitron.conversation import conv_templates, SeparatorStyle
from vitron.model.builder import load_pretrained_model
from vitron.serve.utils import load_image, image_ext, video_ext
from vitron.utils import disable_torch_init
from vitron.mm_utils import process_images, tokenizer_image_token, get_model_name_from_path, KeywordsStoppingCriteria
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="Vitron")
