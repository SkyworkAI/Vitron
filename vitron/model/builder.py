...
from vitron.constants import DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN, \
...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda", **kwargs):
    ...
    if 'llava' in model_name.lower():
        ...
        if 'lora' in model_name.lower() and model_base is not None:
            ...
            print('Loading additional non-lora trainable weights...')
            ...
            if 'mpt' in model_name.lower():
                ...
                model = LlavaLlamaForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, ignore_mismatched_sizes=True, **kwargs)
    else:
        # Load language model
